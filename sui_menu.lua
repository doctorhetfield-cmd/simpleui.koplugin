                                        ...
                                        sub_item_table = {
                                            {
                                                ...
                                                sub_item_table = {
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        sub_item_table = {
                                                            {
                                                                text           = _("Circle (original)"),
                                                                radio          = true,
                                                                checked_func   = function() return FC.getBadgeStyle() == "current" end,
                                                                keep_menu_open = true,
                                                                callback       = function() FC.setBadgeStyle("current"); FC.invalidateCache(); _refreshFC() end,
                                                            },
                                                            {
                                                                text           = _("Double border, padded"),
                                                                radio          = true,
                                                                checked_func   = function() return FC.getBadgeStyle() == "v1" end,
                                                                keep_menu_open = true,
                                                                callback       = function() FC.setBadgeStyle("v1"); FC.invalidateCache(); _refreshFC() end,
                                                            },
                                                            {
                                                                text           = _("Double border, slim shadow"),
                                                                radio          = true,
                                                                checked_func   = function() return FC.getBadgeStyle() == "v2" end,
                                                                keep_menu_open = true,
                                                                callback       = function() FC.setBadgeStyle("v2"); FC.invalidateCache(); _refreshFC() end,
                                                            },
                                                            {
                                                                text           = _("Double border, transparent"),
                                                                radio          = true,
                                                                checked_func   = function() return FC.getBadgeStyle() == "v3" end,
                                                                keep_menu_open = true,
                                                                callback       = function() FC.setBadgeStyle("v3"); FC.invalidateCache(); _refreshFC() end,
                                                            },
                                                            {
                                                                text           = _("Double border, text-fitted"),
                                                                radio          = true,
                                                                checked_func   = function() return FC.getBadgeStyle() == "v4" end,
                                                                keep_menu_open = true,
                                                                callback       = function() FC.setBadgeStyle("v4"); FC.invalidateCache(); _refreshFC() end,
                                                            },
                                                        },
                                                    },
                                                },
